...
export default function FatherBackgroundPage({ onBack, onNext }: FatherBackgroundPageProps) {
  ...
  const { fatherBackground } = formData;
  const [otherStatus, setOtherStatus] = useState("");

  const handleInputChange = (field: keyof typeof fatherBackground, value: string) => {
    updateFormData('fatherBackground', {
      ...fatherBackground,
      [field]: value
    });
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input 
              ...
              value={fatherBackground.familyName}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.firstName}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.middleName}
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div>
            ...
            <input 
              type="date" 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.birthDate}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.placeOfBirth}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.nationality}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.religion}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.landlineNumber}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.mobileNumber}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.emailAddress}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-1">
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.homeAddress}
          ...
          <div className="md:col-span-1">
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.stateProvince}
          ...
          <div className="md:col-span-1">
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.zipPostalCode}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.educationalAttainmentCourse}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.occupationalPositionHeld}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.employerCompany}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.companyAddress}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.city}//palitan mo toh
              onChange={(e) => handleInputChange('city', e.target.value)}
            />
          </div>
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.businessTelephoneNumber}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Answer Here..." 
              className="border border-gray-300 rounded px-2 py-1 w-full text-black"
              value={fatherBackground.annualIncome}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-2">
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  checked={fatherBackground.statusOfParent === "Married"}
              ...
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  name="status"
                  className="radio radio-sm text-black bg-gray-100 border border-gray-300"
                  checked={fatherBackground.statusOfParent === "Single Parent"}
              ...
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  name="status"
                  className="radio radio-sm text-black bg-gray-100 border border-gray-300"
                  checked={fatherBackground.statusOfParent === "Separated"}
              ...
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  name="status"
                  className="radio radio-sm text-black bg-gray-100 border border-gray-300"
                  checked={fatherBackground.statusOfParent === "Widowed"}
              ...
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  name="status"
                  className="radio radio-sm text-black bg-gray-100 border border-gray-300"
                  checked={fatherBackground.statusOfParent === "Widowed, Remarried"}
              ...
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  name="status"
                  className="radio radio-sm text-black bg-gray-100 border border-gray-300"
                  checked={fatherBackground.statusOfParent?.startsWith("Others")}
                  onChange={() => handleStatusChange("Others")}
                /> Others:
                {fatherBackground.statusOfParent?.startsWith("Others") && (
                  <input
                    type="text"
